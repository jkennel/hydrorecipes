...
# frec[, wl := wl - baro]
frec2 = Recipe$new(formula = wl~baro+datetime+earthtide, data = frec)$
  add_step(StepBaroAcworth$new(water_level = wl,
                               baro = baro,
...
frec2 = Recipe$new(formula = wl~baro+datetime+earthtide, data = frec)$
  add_step(StepBaroRau$new(water_level = wl,
                               baro = baro,
                               earth_tide = earthtide,
                               time = datetime))$
  prep()$
