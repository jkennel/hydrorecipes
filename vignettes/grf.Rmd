...
p1 <- plot_ly(grf, x = ~time, y = ~drawdown_lin,
        type = "scatter", mode = "lines",
        name = "linear")

p2 <- plot_ly(grf, x = ~time, y = ~drawdown_rad,
        type = "scatter", mode = "lines",
        name = "radial")

p3 <- plot_ly(grf, x = ~time, y = ~drawdown_sph,
        type = "scatter", mode = "lines",
        name = "spherical")

p4 <- plot_ly(grf, x = ~time, y = ~flow_rate,
        type = "scatter", mode = "lines",
        name = "flow rates")
