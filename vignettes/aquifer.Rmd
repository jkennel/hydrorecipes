...
theis_aniso_x <- recipe(time~flow_rate, dat) |>
...
theis_aniso_y <- recipe(time~flow_rate, dat) |>
  step_aquifer_theis_aniso(time = time,
                   flow_rate = flow_rate,
                   thickness = 1.0,
                   distance_x = 0,
...
theis_aniso_xy <- recipe(time~flow_rate, dat) |>
  step_aquifer_theis_aniso(time = time,
                   flow_rate = flow_rate,
                   thickness = 1.0,
...
# isotropic higher K
theis_aniso_iso_high <- recipe(time~flow_rate, dat) |>
  step_aquifer_theis_aniso(time = time,
                   flow_rate = flow_rate,
                   thickness = 1.0,
                   distance_x = 20,
  ...
  plate()
# isotropic lower K
theis_aniso_iso_low <- recipe(time~flow_rate, dat) |>
  step_aquifer_theis_aniso(time = time,
                   flow_rate = flow_rate,
                   thickness = 1.0,
                   distance_x = 20,
