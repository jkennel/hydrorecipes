...
- **distributed_lag_baro** The barometric component of the water pressure (meters water) 
- **earthtide_datetime** The contribution of Earth tides (meters water)
- **intercept** A single offset value (meters_water)
- **ns_datetime** The background trend (meters water)
- **predicted** The sum of all the components above.  This is the predicted water pressure. (meters water)

```{r fig.height = 12, fig.width = 12, out.width = '90%', warning = FALSE}
